        ...
        var relink = function ($, program, extension) {
            if (program.relink) {
                $('a[href]').each(function (i, elem) {
                    ...
                    var origUrl = url;
                    var ext1 = url.substr(url.length - 3).toLowerCase();
                    var ext2 = url.substr(url.length - 9).toLowerCase();

                    if (ext1 === '.md') {
                        url = url.substr(0, url.length - 3) + extension;
                    }

                    if (ext2 === '.markdown') {
                        url = url.substr(0, url.length - 9) + extension;
                    }
